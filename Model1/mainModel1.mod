...
// FLOW CONTROL OF CSP MODEL 1 : MINIMIZATION OF NUMBER OF OBJETCS USED
// USING COLUMN GENERATION
 ...
 main{
	...
	var masterSource = new IloOplModelSource("modelCSPminObj.mod");
	...
	var subSource = new IloOplModelSource("OKP.mod");
	...
	if(masterCplex.solve()){
    	...
    	writeln("\nNUMBER OF CUTTING PATTERNS USED: ", soma);
    }
